...
## Scope vs java-reviewer / springboot-reviewer

| Concern | Owner |
|---|---|
| Java OOP, streams, concurrency patterns | `java-reviewer` |
| Spring Boot, JPA, transactions, security | `springboot-reviewer` |
| **Maven/Gradle build failures, dependency conflicts** | **java-build-resolver** |
| **Compilation errors, annotation processing** | **java-build-resolver** |
| **JDK version compatibility, module system** | **java-build-resolver** |
...
## Approval Criteria
- **Ready**: Build passes with Maven/Gradle, all modules compile
- **Warning**: Build passes with deprecation warnings
