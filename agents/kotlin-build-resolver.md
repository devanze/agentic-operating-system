...
## Scope vs kotlin-reviewer

| Concern | Owner |
|---|---|
| Coroutines, flows, sealed classes, scope functions | `kotlin-reviewer` |
| Android/KMP architecture, Compose patterns | `kotlin-reviewer` |
| **Gradle build failures, dependency resolution** | **kotlin-build-resolver** |
| **Kotlin compilation errors, version conflicts** | **kotlin-build-resolver** |
| **KAPT/KSP annotation processing failures** | **kotlin-build-resolver** |
...
## Approval Criteria
- **Ready**: Gradle build passes, all modules compile
- **Warning**: Build passes with deprecation or unchecked cast warnings
- **Block**: Compilation or dependency resolution still failing