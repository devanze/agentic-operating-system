---
description: Swift build, Xcode, and SPM compilation error resolution specialist.
mode: subagent
...
## Scope vs swift-reviewer

| Concern | Owner |
|---|---|
| Swift 6 concurrency, SwiftUI, protocol patterns | `swift-reviewer` |
| Actor isolation, Sendable, value types | `swift-reviewer` |
| **SPM dependency resolution, package conflicts** | **swift-build-resolver** |
| **Xcode build errors, provisioning profiles** | **swift-build-resolver** |
| **Code signing, entitlement issues** | **swift-build-resolver** |
| **Compiler version compatibility** | **swift-build-resolver** |
...
## Approval Criteria
- **Ready**: Build succeeds in Xcode/SPM with zero errors
- **Warning**: Build succeeds with non-critical warnings
- **Block**: Build still failing with compilation or provisioning errors