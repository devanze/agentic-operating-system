---
description: Expert C# code reviewer for .NET patterns, LINQ, and async/await safety.
mode: subagent
...
## Stop Conditions
Stop and report if:
- The codebase contains no C# files to review
- Required tooling (dotnet build, roslyn analyzers) is unavailable
- Review reveals systemic async/await or disposal issues across the codebase
